...
QString TextInterface::getTextScannerInfo() {
  TextScannerInfo =
      "Scanner will provide the possibility "
...
QString TextInterface::getTextLicense() {
  TextLicense =
      ...
      "and non profit purpose. For any other use within a organization, "
      "there is the need to request for a license at info@serial2net.ch \r\n"
      "\r\n"
      "The software includes the libssh2 library >https://www.libssh2.org>. "
      "\r\n "
      "libssh2 is open source licensed under the 3-clause BSD License. \r\n"
...
QString TextInterface::getTextEncyption() {
  TextEncyption =
      "The encryption of libssh2 is done by OpenSSL v1.0.2k "
      "\r\n";
...
QString TextInterface::getTextHelp() {
  TextHelp =
      "For help hover the cursor over a input field and the ToolTip will "
